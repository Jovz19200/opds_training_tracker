  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1">
        ...
        <section className="bg-slate-50 dark:bg-black py-16">
          <div className="container max-w-6xl mx-auto px-4 md:px-6">
            <div className="text-center mb-12">
              <h2 className="text-2xl md:text-3xl font-bold mb-4">Technical Specifications</h2>
              <p className="text-muted-foreground max-w-3xl mx-auto">
                Built with modern technologies to ensure security, scalability, and user-friendliness.
              </p>
            </div>

            <div className="bg-background rounded-lg border p-6 md:p-8 dark:border-zinc-800">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div>
                  <h3 className="text-lg font-bold mb-4">Deployment</h3>
                  <ul className="space-y-2">
                    <li className="flex items-center">
                      <span className="w-3 h-3 bg-orange-500 rounded-full mr-2"></span>
                      <span>Cloud-based hosting</span>
                    </li>
                    <li className="flex items-center">
                      <span className="w-3 h-3 bg-orange-500 rounded-full mr-2"></span>
